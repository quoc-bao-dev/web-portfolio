...
const HomeSection = () => {
  ...
  const handleDownloadCV = () => {
    ...
    link.href = "/cv/cv-front-end.pdf";
    link.download = "cv-front-end.pdf";
              ...
              <div>
                <h1 className="text-3xl md:text-[64px] md:leading-[72px] font-bold text-primary dark:text-white">
                  ...
                  <span className="text-primary">
                    <Typewriter
                      words={["Quoc Bao!", "a Frontend Developer!"]}
                      loop={true}
                      cursor
                      cursorStyle="_"
                      typeSpeed={100}
                ...
                <p className="text-base md:text-lg font-medium text-gray-600 dark:text-gray-400 mt-6 md:leading-[28px]">
                  I’m a Front-end Developer passionate about creating innovative
                  and optimized web applications. With a strong foundation in
                  React.js, Next.js, TypeScript, and API development, I am ready
                  to turn your ideas into reality.
                </p>
                <div className="mt-10 ">
                  <button
                    onClick={handleDownloadCV}
                    className="px-4 md:px-8 py-2 md:py-2 bg-primary font-bold text-white border-none outline-none rounded-lg hover:bg-primary/90 transition-colors duration-200 cursor-pointer"
                  >
                    Portfolio
                  </button>
                </div>
